...
<div id="create_comics">
    <h1 class="text-center">Aggiorna il Comic</h1>
    <div class="container">
        ...
        <form action="{{ route('admin.comics.update', $comic->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="thumb" id="thumb" class="form-control @error('thumb') is-invalid @enderror" placeholder="Inserisci URL Immagine" aria-describedby="imageHelper" value="{{ $comic->thumb }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="price" id="price" class="form-control @error('price') is-invalid @enderror" placeholder="Inserisci il prezzo" value="{{ $comic->price }}">
                @error('price')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" name="series" id="series" class="form-control @error('series') is-invalid @enderror" placeholder="Inserisci la serie" aria-describedby="serieHelper" value="{{ $comic->series }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="sale_date" id="sale_date" class="form-control @error('sale_date') is-invalid @enderror" placeholder="Inserisci la data di uscita" aria-describedby="saleDateHelper" value="{{ $comic->sale_date }}">
            ...
            <div class="pb-3">
                ...
                <input type="text" name="type" id="type" class="form-control @error('type') is-invalid @enderror" placeholder="Inserisci il tipo" aria-describedby="typeHelper" value="{{ $comic->type }}">
