...
<div id="create_comics">
    <h1 class="text-center">Crea un nuovo Movie</h1>
    <div class="container">
        ...
        <form action="{{ route('movies.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="cover" id="cover" class="form-control @error('cover') is-invalid @enderror" placeholder="Inserisci URL Immagine di sfondo" aria-describedby="imageHelper" value="{{ old('cover') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="director" id="director" class="form-control @error('director') is-invalid @enderror" placeholder="Inserisci il Regista" value="{{ old('director') }}">
                @error('director')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" name="genre" id="genre" class="form-control @error('genre') is-invalid @enderror" placeholder="Inserisci il genere" aria-describedby="serieHelper" value="{{ old('genre') }}">
